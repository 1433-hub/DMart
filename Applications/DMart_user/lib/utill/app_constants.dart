import 'package:dmart/data/model/response/language_model.dart';

class AppConstants {
  static const String APP_NAME = 'Dmart';

  static const String BASE_URL = 'http://192.168.0.16/website/dmart';
  ...
  static const String TOPIC = 'vrcmart';

  static List<LanguageModel> languages = [
    LanguageModel(imageUrl: '', languageName: 'English', countryCode: 'US', languageCode: 'en'),
    LanguageModel(imageUrl: '', languageName: 'Nepali', countryCode: 'NE', languageCode: 'ne'),
  ];
}
